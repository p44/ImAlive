...
object Models {
  ...
  lazy val customerDeviceCatalog: Seq[Device] = Seq[Device](
      ...
      Device(1001L, cid1, "0090990F9F99", "222.222.222.222", 38.907231,-77.036464, "Email reader 39", "12,0,66,99,1,1,0"),
      ...
      Device(7002L, cid2, "0040110F8B77", "111.333.333.14", 40.0176, 105.2797, "Of The People By The People Z", "101110110101")
      )
...
object StatusMessage {
  ...
  def simulateFromDevice(d: Device, ts: Long, msg: String): StatusMessage = {
    ...
    val cName = Models.getCustomerName(d.cid).getOrElse("Not Found")
